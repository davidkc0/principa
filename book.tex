...
\section{Utah Raptor, an invitation to explore!}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/silk_moth.jpg}
    \caption{The Silk Moth and the Lion \cite{rumi_gbno}}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/lion_poem.png}
    \caption{\cite{rumi_moses}}
\end{figure}
