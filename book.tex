...
% conways code, newtons method

\section{Euler's Approximation}
...
\begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{figures/ofig/Screenshot 2025-01-13 at 5.03.25 PM.png}
    \end{figure}
